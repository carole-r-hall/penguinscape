...
{
  tmp_ground_truth <- "adar_downsampled_annotations_for_validation" # these were resampled into comparable rasters using disagg() or agg() from terra -- also remember to crop the rasters as 
